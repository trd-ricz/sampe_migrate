...
// 		}
	...
	*/
	...
	function classSchedNotEmpty() {
		console.log("class_sched not empty");
		for (var fIndex in class_sched){
...
<?php 
// echo "teacher data: </br>";
// foreach ($scheduleArr as $fSchedule) {
// 	print_r($fSchedule);
// 	echo "</br></br>";
// }
...
// 						$localStudentId = get_post_meta($sched["post_id"], "student")[0][0];
// 						$localStudentEndDate = get_user_meta($localStudentId, "end_date");
// 						$localGraduatingClass = "";
// 						if ($localStudentEndDate == $_REQUEST["end"]) {
// 							$localGraduatingClass = " graduating";
// 						}
// 						echo "local graduating class: ".$localGraduatingClass."</br>";
						?>
					
			<td style="text-align: center;" class="teacher-print<?php echo $localGraduatingClass; ?>"> <?php echo $sched[$x]["student"][0].$room; ?> </td>
		...
		<tr class="row-hide">
			...
			<td colspan="2" style="text-align: center;" > 
					...
					for ( $x2 = 0; $x2 < count($sched[$x]["student"]); $x2++ ) {
						if ( $x2 > 0 ) { echo "; "; } 
					?>
						<span class="teacher-print"> <?php echo $sched[$x]["student"][$x2]; ?> </span> 
					<?php 
					} 
					?> 
			</td>
